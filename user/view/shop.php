                  ...
                  echo '<div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                          <div class="block-4 text-center border">
                            <figure class="block-4-image">
                              <a href="index.php?act=product&id=' . $sp['id'] . '"><img src="../../uploads/' . $sp['img'] . '" alt="Image placeholder" class="img-fluid"></a>
                            </figure>
                            <div class="block-4-text p-4">
                              <h3><a href="index.php?act=product&id=' . $sp['id'] . '">' . $sp['tensp'] . '</a></h3>
                              <p class="mb-0">New</p>
          ...
          <div class="col-md-3 order-1 mb-5 mb-md-0">
            <div class="border p-4 rounded mb-4">
              ...
              <ul class="list-unstyled mb-0">
                  <?php
                    foreach($dsdm as $dm){
                        echo'  <li class="mb-1"><a href="index.php?act=shop&id='.$dm['id'].'" class="d-flex"><span>'.$dm['tendm'].'</span></a></li>';
                    }
                  ?>
              </ul>
            </div>
